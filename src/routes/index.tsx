    ...
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-6">
        <div className="text-center mb-12">
          <h1 className="font-display text-5xl sm:text-6xl font-bold text-gold leading-tight">Madilu PG</h1>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          >
            <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-20" style={{ background: "radial-gradient(circle, #4ECDC4, transparent 70%)" }} />
            <div className="relative">
              ...
              <p className="text-white/50 text-sm leading-relaxed">Create and manage agreements for your assigned PG property.</p>
            </div>
          </button>
          ...
          <button
            ...
            className="glass glass-hover rounded-3xl p-10 text-left group relative overflow-hidden"
          >
            <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-20" style={{ background: "radial-gradient(circle, #D4A853, transparent 70%)" }} />
            <div className="relative">
              ...
              <p className="text-white/50 text-sm leading-relaxed">Approve agreements, manage PG managers, and oversee operations.</p>
            </div>
          </button>
        </div>
