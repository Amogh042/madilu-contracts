...
export function buildAgreementSections(d: AgreementData): AgreementSection[] {
  ...
  sections.push({
    type: "sub-clause",
    text: 'A. The Owner is running and managing a Paying Guest accommodation facility under the name and style of "Madilu PG Accommodation" at Kumaraswamy Layout, Bengaluru, Karnataka.',
    indent: 1,
  });
  ...
  sections.push({
    type: "sub-clause",
    text: "C. The Owner has agreed to grant a temporary license to the Resident for use and occupation of a bed space in the said room, subject to the terms and conditions set forth herein.",
    indent: 1,
  });

  sections.push({
    type: "paragraph",
    text: "NOW THEREFORE, in consideration of the mutual covenants and agreements herein contained, the Parties agree as follows:",
  });

  // Clause 1
  sections.push({
    type: "clause-title",
    text: "CLAUSE 1 — NATURE OF AGREEMENT & DURATION",
    bold: true,
  });
  sections.push({
    type: "sub-clause",
    text: "1.1 This Agreement is a temporary, revocable license to use and occupy a bed space in the designated room of the PG facility. It does not create any tenancy, lease, sub-lease, or any right of exclusive possession in favour of the Resident. The physical possession of the premises shall at all times remain with the Owner.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 2 — LICENSE FEE & SECURITY DEPOSIT",
    bold: true,
  });
  ...
  sections.push({
    type: "sub-clause",
    text: "2.2 In the event of late payment beyond the due date, a late payment fine of 10% of the due amount OR Rs. 1,000/-, whichever is higher, shall be levied. Intimation of dues shall be made via Crib software/WhatsApp.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 3 — MANDATORY LOCK-IN & NOTICE PERIOD",
    bold: true,
  });
  const clause31 = segs(
  ...
  sections.push({
    type: "sub-clause",
    text: "3.2 After completion of the lock-in period, the Resident shall provide a minimum of 30 (Thirty) days written notice via WhatsApp/Email before vacating. Failure to provide such notice shall result in deduction of one month's rent from the Security Deposit.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 4 — SCOPE OF FACILITIES & UTILITIES",
    bold: true,
  });
  sections.push({
    type: "sub-clause",
    text: "4.1 The License Fee includes the use of the following facilities: bed, mattress, locker/wardrobe, Wi-Fi, water supply, and housekeeping services.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "4.2 Use of heavy electrical appliances such as induction cooktops, room heaters, or air coolers is strictly prohibited without prior written consent of the Owner and payment of applicable extra charges.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "4.3 The Resident shall be liable for any electrical damage caused due to misuse or unauthorized use of appliances. Repair costs shall be recovered from the Resident or deducted from the Security Deposit.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 5 — MANDATORY HOUSE RULES & CONDUCT",
    bold: true,
  });
  sections.push({
    type: "sub-clause",
    text: "5.1 Curfew time is 9:30 PM. Late entry shall be permitted only with prior approval from both the Parent/Guarantor and the Owner.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "5.2 No visitors shall be allowed inside the PG premises without explicit written permission from the Owner.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "5.3 ZERO TOLERANCE POLICY: Consumption, possession, or distribution of alcohol, tobacco, cigarettes, e-cigarettes/vapes, or any narcotic/illegal substance within the premises shall result in immediate expulsion from the PG facility and forfeiture of the entire Security Deposit.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "5.4 Quiet hours shall be observed from 11:00 PM to 7:00 AM. No loud music, shouting, or nuisance behavior shall be permitted during these hours.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 6 — AMC (ANNUAL MAINTENANCE CHARGES)",
    bold: true,
  });
  const clause6 = segs(
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 7 — POLICE VERIFICATION & COMPLIANCE DOCUMENTS",
    bold: true,
  });
  sections.push({
    type: "paragraph",
    text: "The Second Party/Resident and Third Party/Guarantor/Parent shall submit copies of Aadhaar Card, College ID, and Parent/Guardian ID at the time of admission. The Resident hereby provides consent for police verification through the Karnataka State Police (KSP) portal as required by law.",
  });

  // Clause 8
  sections.push({
    type: "clause-title",
    text: "CLAUSE 8 — LIABILITY & PERSONAL BELONGINGS",
    bold: true,
  });
  sections.push({
    type: "sub-clause",
    text: "8.1 The Owner shall not be liable for any loss, theft, or damage to the personal belongings of the Resident.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "8.2 Any damage caused to the property of the PG facility shall be evaluated by the Owner, and the cost of repair/replacement shall be recovered from the Resident or deducted from the Security Deposit.",
    indent: 1,
  });
  ...
  sections.push({
    type: "clause-title",
    text: "CLAUSE 9 — TERMINATION OF LICENSE & COMPLIANCE",
    bold: true,
  });
  sections.push({
    type: "sub-clause",
    text: "9.1 The Owner reserves the right to terminate this License and evict the Resident within 24 hours in the event of: (a) non-payment of License Fee within 10 days of the due date; (b) violation of the Zero Tolerance Policy under Clause 5.3; (c) any illegal activity or conduct bringing disrepute to the PG facility.",
    indent: 1,
  });
  sections.push({
    type: "sub-clause",
    text: "9.2 The Resident and Parent/Guarantor shall abide by all rules and regulations of the PG facility, which form an integral part of this Agreement.",
    indent: 1,
  });
  ...
  sections.push({
    type: "signature-row",
    text: `THIRD PARTY / GUARANTOR/PARENT\n\n\nSignature: ______________________\n${blank(s.guardianName)}`,
  });
...
export function buildAgreementParagraphs(d: AgreementData): string[] {
  ...
  return sections.map((s) => {
    if (
      s.bold &&
      (s.type === "clause-title" || s.type === "header" || s.type === "section-title")
    ) {
      return `**${s.text}**`;
    }
