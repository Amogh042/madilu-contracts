...
export function agreementDataToRow(d: AgreementData, managerId: string | null) {
  ...
  if (d.totalAmount) snapObj.totalAmount = d.totalAmount;
  ...
  return {
    ...
    student_phone: d.student.contactNumber,
    student_email: d.student.email,
    student_dob: d.student.dob,
    student_address: d.student.permanentAddress,
    guardian_name: d.student.guardianName,
    guardian_phone: d.student.guardianPhone,
    guardian_email: d.student.guardianEmail,
    guardian_address: d.student.guardianAddress,
    pg_name: d.pgName,
    ...
    resident_aadhaar: d.residentAadhaar,
...
export function rowToAgreementData(r: DbAgreement): AgreementData {
  ...
  return {
    student: {
      name: r.student_name,
      dob: r.student_dob || "",
      contactNumber: r.student_phone || "",
      email: r.student_email || "",
      pgOption: r.pg_name || "",
      permanentAddress: r.student_address || "",
      age: r.resident_age || "",
      collegeName: r.resident_college || "",
      studentId: r.resident_student_id || "",
