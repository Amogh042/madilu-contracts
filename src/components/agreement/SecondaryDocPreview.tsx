...
function ExtensionPreview({ a }: { a: DbAgreement }) {
  return (
    <>
      ...
      <p className="mb-2">
        Mr. {blank(a.owner_name)}, Proprietor of Madilu PG Accommodation, located at{" "}
        {blank(a.pg_address)}, Kumaraswamy Layout, Bangalore - 560078.
      </p>
      ...
      <p className="mb-1">
        Ms./Mr. {blank(a.student_name)}, S/D/o {blank(a.guardian_name)},
      </p>
      ...
      <p className="mb-2">
        Residing in Room No: {blank(a.room_number)} at Madilu PG Accommodation.
      </p>
      ...
      <p className="mb-2 pl-3">
        1. The Second Party was admitted to the PG on {fmtDate(a.start_date)} under a rental
        agreement valid till {fmtDate(a.end_date)}.
      </p>
      ...
      <p className="mb-1 pl-3">
        The tenure is hereby extended from ____________ to ____________ for a mandatory period of 12
        months.
      </p>
      <p className="mb-1 pl-3">Extension year shall be 20__.</p>
      <p className="mb-3 pl-3">
        The Second Party agrees not to vacate before completion of 12 months.
      </p>
      ...
      <p className="mb-3 pl-3">
        If rent is not paid on or before the due date, a late fine of Rs. 1000/- shall be applicable
        for that month.
      </p>
      ...
      <div className="grid grid-cols-2 gap-8">
        <pre className="text-sm whitespace-pre-wrap font-serif">
          {"PG Owner: ______________________\nName: " +
            blank(a.owner_name) +
            "\nDate: ______________________"}
        </pre>
        <pre className="text-sm whitespace-pre-wrap font-serif">
          {"Student: ______________________\nName: " +
            blank(a.student_name) +
            "\nDate: ______________________"}
        </pre>
      </div>
...
function ExitPreview({ a }: { a: DbAgreement }) {
  return (
    <>
      ...
      <p className="mb-3">
        I, {blank(a.student_name)}, was residing in Room No {blank(a.room_number)} at Madilu PG
        Accommodation since {fmtDate(a.start_date)}.
      </p>
      ...
      <p className="mb-1 pl-3">
        2. Room & Property: Room, keys, ID card handed over in good condition.
      </p>
      <p className="mb-3 pl-3">
        3. Security Deposit: Kindly refund Rs. {inr(a.security_deposit)}/- to UPI/Bank A/c:
        ____________ after deducting damages, if any.
      </p>

      <p className="mb-4">I request you to issue a No-Dues Certificate and confirm my exit.</p>

      <p className="mb-3">Yours obediently,</p>
      <pre className="text-sm whitespace-pre-wrap font-serif mb-4">
      ...
      <div className="border-t-2 border-gray-300 mt-8 pt-6">
        ...
        <p className="mb-3">
          This is to certify that Mr./Ms. {blank(a.student_name)}, Room No {blank(a.room_number)}{" "}
          has vacated Madilu PG Accommodation on ____________.
        </p>

        <p className="mb-3">All dues cleared / adjusted.</p>

        <p className="mb-3">
          Security Deposit of Rs. {inr(a.security_deposit)}/- has been refunded / adjusted on
          ____________.
        </p>
        ...
        <p className="italic text-sm text-gray-500 mb-4">
          Note: For students exiting before 12 months, security deposit forfeited as per Extension
          Agreement Clause 6.
        </p>
...
export function SecondaryDocPreview({ agreement, docType, onBack }: Props) {
  ...
  const title =
    docType === "extension" ? "Tenure Extension Agreement" : "Exit / No-Dues Certificate";
    ...
    <div className="glass rounded-3xl p-8 animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-white/50 text-sm mt-1">
          Review before downloading. Blank fields are for manual filling.
        </p>
      </div>

      <div
        className="rounded-2xl bg-[#fdfaf3] text-[#1a1a1a] p-10 max-h-[600px] overflow-y-auto shadow-2xl"
        style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
      >
        <div className="text-[13px] leading-[1.8] text-justify">
          {docType === "extension" ? (
            <ExtensionPreview a={agreement} />
          ) : (
            <ExitPreview a={agreement} />
          )}
        </div>
      </div>
      ...
      <div className="flex justify-between mt-8">
        ...
        <button
          ...
          className="btn-gold rounded-xl px-8 py-3 text-sm font-semibold"
        >
          Download PDF
        </button>
      </div>
